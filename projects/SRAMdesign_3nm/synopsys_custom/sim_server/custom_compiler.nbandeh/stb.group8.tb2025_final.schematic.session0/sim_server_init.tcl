...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 31172
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.nbandeh/stb.group8.tb2025_final.schematic.session0
}
