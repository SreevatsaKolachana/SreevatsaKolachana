...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    set ::sa::_simServer::_simServerId stb.group8.memory_array_tb.schematic.session5
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 25945
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.svkolach/stb.group8.memory_array_tb.schematic.session5
}
