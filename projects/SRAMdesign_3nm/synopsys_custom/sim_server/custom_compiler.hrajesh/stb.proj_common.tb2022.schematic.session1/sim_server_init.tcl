...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    set ::sa::_simServer::_simServerId stb.proj_common.tb2022.schematic.session1
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 130880
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.hrajesh/stb.proj_common.tb2022.schematic.session1
}
