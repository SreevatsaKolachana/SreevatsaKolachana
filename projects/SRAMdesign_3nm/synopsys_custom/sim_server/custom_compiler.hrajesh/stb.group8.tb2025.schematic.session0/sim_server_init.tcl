...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 209864
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.hrajesh/stb.group8.tb2025.schematic.session0
}
