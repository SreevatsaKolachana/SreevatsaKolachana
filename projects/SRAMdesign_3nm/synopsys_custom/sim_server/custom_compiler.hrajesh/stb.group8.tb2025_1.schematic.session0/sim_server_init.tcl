...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.hrajesh/stb.group8.tb2025_1.schematic.session0
}
