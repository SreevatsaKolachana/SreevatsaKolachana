...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    set ::sa::_simServer::_simServerId stb.group8.WLRef_PC_tb.schematic.session1
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 26472
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /mnt/coe/workspace/ece/ece546-spr25/group8/group8_project/synopsys_custom/sim_server/custom_compiler.hrajesh/stb.group8.WLRef_PC_tb.schematic.session1
}
