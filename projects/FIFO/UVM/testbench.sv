...
initial begin
   uvm_config_db#(virtual wr_if)::set(null, "uvm_test_top.env.i_agt_h.drv_h", "wr_if", wr_if);
   uvm_config_db#(virtual wr_if)::set(null, "uvm_test_top.env.i_agt_h.mon_h", "wr_if", wr_if);
   uvm_config_db#(virtual rd_if)::set(null, "uvm_test_top.env.o_agt_h.drv_h", "rd_if", rd_if);
   uvm_config_db#(virtual rd_if)::set(null, "uvm_test_top.env.o_agt_h.mon_h", "rd_if", rd_if);
end
